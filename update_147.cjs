...
const md14_7 = paragraphs.join('\n');

const chapterId = 'chapter-14-7';
...
let mdEndIdx = content.lastIndexOf('`', nextChapIdx);
if(mdEndIdx === -1 || mdEndIdx < mdStartIdx) {
  mdEndIdx = content.indexOf('`\\n  },\\n', startIdx);
}
