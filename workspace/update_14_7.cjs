...
The expression $D = f_{xx}f_{yy} - f_{xy}^2$ is called the **discriminant** or **Hessian** of $f$. It is also written as:
...
### Example 2: Finding Local Extreme Values of a Polynomial
...
### Example 3: Absolute Extrema on a Closed Bounded Region
